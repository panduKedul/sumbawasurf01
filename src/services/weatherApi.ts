  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg} pt-16`}>
      ...
      <div className={`${themeClasses.cardBg} border-b ${themeClasses.border} p-3 sm:p-4 lg:p-6`}>
        <div className="max-w-sm sm:max-w-md lg:max-w-4xl mx-auto">
          <div className="text-center mb-4">
            <div className="flex flex-col items-center space-y-2 sm:space-y-3 mb-3 sm:mb-4">
              ...
              <div>
                <h1 className={`text-base sm:text-lg lg:text-3xl font-bold ${themeClasses.accent}`}>
      ...
      {/* Main Content */}
      <div className="p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 max-w-sm sm:max-w-md lg:max-w-4xl mx-auto">
        
        {/* Current Weather Hero Card */}
        {currentWeather && (
          <div className={`${themeClasses.cardBg} rounded-lg shadow-sm overflow-hidden`}>
            <div className="p-3 sm:p-4 lg:p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {/* Left Side - Main Weather */}
                <div className="text-center">
                  <h2 className={`text-sm sm:text-base lg:text-xl font-bold ${themeClasses.text} mb-2`}>Current Conditions</h2>
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 mb-3">
                    <div className={`p-2 ${themeClasses.headerBg} rounded-lg`}>
                ...
                <div className="space-y-2 sm:space-y-3">
                  {/* Wind Info */}
                  <div className={`${themeClasses.cardBg} p-2 sm:p-3 rounded-lg border ${themeClasses.border}`}>
                    <div className="flex items-center space-x-2 mb-2">
                      <Wind className={`w-4 h-4 ${themeClasses.accent}`} />
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        <div className={`text-sm font-bold ${themeClasses.accent} flex items-center justify-center space-x-1`}>
                  ...
                  <div className={`${themeClasses.cardBg} p-2 sm:p-3 rounded-lg border ${themeClasses.border}`}>
                    <div className="flex items-center space-x-2 mb-2">
                      <Waves className={`w-4 h-4 ${themeClasses.accent}`} />
        ...
        {/* Weather Map */}
        <div className={`${themeClasses.cardBg} rounded-lg overflow-hidden shadow-sm`}>
          <div className={`p-3 border-b ${themeClasses.border}`}>
            <h3 className={`text-sm sm:text-base lg:text-lg font-bold ${themeClasses.text} text-center`}>Live Weather Map</h3>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          {[
            ...
            { icon: Activity, label: 'Pressure', value: `${currentWeather?.pressure?.toFixed(0) || 1013} hPa`, color: 'text-green-500' }
          ].map((item, index) => (
            <div key={index} className={`${themeClasses.cardBg} p-2 sm:p-3 rounded-lg text-center shadow-sm border ${themeClasses.border}`}>
              ...
              <div className={`text-xs sm:text-sm font-bold ${themeClasses.text} mb-1`}>{item.value}</div>
        ...
        <div className={`${themeClasses.cardBg} rounded-lg shadow-sm overflow-hidden`}>
          <div className={`p-3 border-b ${themeClasses.border}`}>
            <h3 className={`text-sm sm:text-base lg:text-lg font-bold ${themeClasses.text} text-center flex items-center justify-center space-x-2`}>
              <Activity className={`w-4 h-4 sm:w-5 sm:h-5 ${themeClasses.accent}`} />
            ...
            <div className="overflow-x-auto">
              <div className="flex gap-2 pb-2" style={{ minWidth: 'max-content' }}>
                {getHourlyForecast().map((hour, index) => (
                  <div key={index} className={`flex-shrink-0 ${themeClasses.cardBg} rounded-lg p-2 sm:p-3 border ${themeClasses.border} min-w-[80px] sm:min-w-[100px] shadow-sm`}>
                    <div className="text-center">
