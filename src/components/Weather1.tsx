  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg} pt-16 overflow-x-hidden`}>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className={`relative ${themeClasses.cardBg} border-b ${themeClasses.border} p-1 sm:p-4 md:p-6 lg:p-8`}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-2 sm:mb-6">
              <div className="flex flex-col items-center space-y-1 sm:space-y-4 mb-2 sm:mb-6">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl blur-lg opacity-30"></div>
                  <div className={`relative p-1 sm:p-4 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg sm:rounded-2xl shadow-2xl`}>
                    <Cloud className="w-3 h-3 sm:w-8 sm:h-8 text-white" />
                  </div>
                </div>
                <div>
                  <h1 className={`text-sm sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-600 bg-clip-text text-transparent mb-1 sm:mb-2`}>
                    Advanced Weather Station
                  </h1>
                  <p className={`text-xs sm:text-base lg:text-lg ${themeClasses.textSecondary} px-2`}>
              ...
              <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 max-w-full sm:max-w-md mx-auto px-1 sm:px-0">
                <select
                  ...
                  className={`${themeClasses.cardBg} ${themeClasses.border} ${themeClasses.text} px-1 sm:px-4 py-1 sm:py-3 rounded-md sm:rounded-xl w-full text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 backdrop-blur-sm shadow-lg`}
                >
                  {spots.map((spot) => (
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-2 sm:px-6 py-1 sm:py-3 rounded-md sm:rounded-xl flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm font-medium transition-all duration-300 shadow-lg backdrop-blur-sm"
                >
                  <RefreshCw className={`w-2 h-2 sm:w-4 sm:h-4 ${loading ? 'animate-spin' : ''}`} />
                  <span>Refresh</span>
                </button>
              </div>
            </div>
      ...
      {/* Main Content */}
      <div className="p-1 sm:p-4 md:p-6 lg:p-8 space-y-2 sm:space-y-6 max-w-full sm:max-w-6xl mx-auto overflow-x-hidden">
        
        {/* Current Weather Hero Card - Enhanced */}
        {currentWeather && (
          <>
            {/* Best Surf Time Recommendation */}
            <div className="relative overflow-hidden rounded-md sm:rounded-2xl mb-2 sm:mb-6">
              ...
              <div className={`relative ${themeClasses.cardBg} p-2 sm:p-6 lg:p-8 shadow-2xl border ${themeClasses.border}`}>
                <div className="text-center">
                  <h2 className={`text-xs sm:text-xl lg:text-2xl font-bold ${themeClasses.text} mb-1 sm:mb-4 flex items-center justify-center`}>
                    <Activity className={`w-3 h-3 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${themeClasses.accent} mr-1 sm:mr-3`} />
                    Today's Surf Recommendations
                  </h2>
                  <div className={`${themeClasses.cardBg} p-1 sm:p-4 lg:p-6 rounded-md sm:rounded-xl border ${themeClasses.border} shadow-lg`}>
                    <p className={`text-xs sm:text-base lg:text-lg ${themeClasses.text} leading-tight sm:leading-relaxed`}>
          ...
          <div className="relative overflow-hidden rounded-md sm:rounded-2xl">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-cyan-500/5 to-purple-500/10 backdrop-blur-xl"></div>
            <div className={`relative ${themeClasses.cardBg} p-1 sm:p-4 md:p-6 lg:p-8 shadow-2xl border ${themeClasses.border}`}>
              <div className="grid grid-cols-1 gap-2 sm:gap-6 lg:gap-8">
                {/* Left Side - Main Weather - Enhanced */}
                <div className="text-center lg:text-left">
                  <h2 className={`text-xs sm:text-xl md:text-2xl lg:text-3xl font-bold ${themeClasses.text} mb-1 sm:mb-4 flex items-center justify-center lg:justify-start`}>
                    <Activity className={`w-3 h-3 sm:w-6 sm:h-6 lg:w-8 lg:h-8 ${themeClasses.accent} mr-1 sm:mr-3`} />
                    Current Conditions
                  </h2>
                  
                  {/* Temperature Description */}
                  <div className={`${themeClasses.cardBg} p-1 sm:p-4 rounded-md sm:rounded-xl mb-1 sm:mb-4 border ${themeClasses.border} shadow-lg`}>
                    <div className="text-left">
                      <h4 className={`font-bold ${themeClasses.accent} mb-0.5 sm:mb-2 text-xs sm:text-sm lg:text-base`}>
                        {getTemperatureCondition(currentWeather.airTemperature).title}
                      </h4>
                      <p className={`text-xs ${themeClasses.textSecondary} mb-0.5 sm:mb-2 leading-tight`}>
                        {getTemperatureCondition(currentWeather.airTemperature).description}
                      </p>
                      <p className={`text-xs ${themeClasses.text} font-medium leading-tight`}>
                        💡 {getTemperatureCondition(currentWeather.airTemperature).recommendation}
                      </p>
                    </div>
                  </div>
                  
                  <div className="flex items-center justify-center lg:justify-start space-x-1 sm:space-x-4 mb-2 sm:mb-6">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl blur-lg opacity-30"></div>
                      <div className={`relative p-1 sm:p-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-md sm:rounded-xl`}>
                        <Thermometer className="w-3 h-3 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-white" />
                      </div>
                    </div>
                    <div>
                      <div className={`text-lg sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent`}>
                  ...
                  {/* Additional Info */}
                  <div className="grid grid-cols-2 gap-1 sm:gap-3 md:gap-4 mb-2">
                    <div className={`${themeClasses.cardBg} p-1 sm:p-3 md:p-4 rounded-md sm:rounded-xl text-center shadow-lg border ${themeClasses.border}`}>
                ...
                <div className="space-y-1 sm:space-y-4">
                  ...
                  <div className="relative overflow-hidden rounded-md sm:rounded-xl">
                    ...
                    <div className={`relative ${themeClasses.cardBg} p-1 sm:p-4 lg:p-6 border ${themeClasses.border} shadow-lg`}>
                      <div className="flex items-center space-x-1 sm:space-x-3 mb-1 sm:mb-4">
                        <Wind className={`w-2 h-2 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${themeClasses.accent}`} />
                        <h3 className={`text-xs sm:text-base md:text-lg lg:text-xl font-bold ${themeClasses.text}`}>Wind</h3>
                      </div>
                      
                      {/* Wind Description */}
                      <div className={`${themeClasses.cardBg} p-1 sm:p-3 rounded-md mb-1 sm:mb-4 border ${themeClasses.border}`}>
                        <h4 className={`font-bold ${themeClasses.accent} mb-0.5 text-xs`}>
                          {getWindCondition(currentWeather.windSpeed).title}
                        </h4>
                        <p className={`text-xs ${themeClasses.textSecondary} mb-0.5 leading-tight`}>
                      ...
                      <div className="grid grid-cols-2 gap-1 sm:gap-3">
                        <div>
                          <div className={`text-xs sm:text-lg md:text-xl lg:text-2xl font-bold ${themeClasses.accent}`}>
                            {currentWeather.windSpeed.toFixed(1)} m/s
                          </div>
                          <div className={`text-xs ${themeClasses.textSecondary}`}>Speed</div>
                        </div>
                        <div>
                          <div className={`text-xs sm:text-lg md:text-xl lg:text-2xl font-bold ${themeClasses.accent} flex items-center space-x-0.5`}>
                            <Compass className="w-2 h-2 sm:w-4 sm:h-4" />
                  ...
                  <div className="relative overflow-hidden rounded-md sm:rounded-xl">
                    ...
                    <div className={`relative ${themeClasses.cardBg} p-1 sm:p-4 lg:p-6 border ${themeClasses.border} shadow-lg`}>
                      <div className="flex items-center space-x-1 sm:space-x-3 mb-1 sm:mb-4">
                        <Waves className={`w-2 h-2 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${themeClasses.accent}`} />
                        <h3 className={`text-xs sm:text-base md:text-lg lg:text-xl font-bold ${themeClasses.text}`}>Waves</h3>
                      </div>
        ...
        <div className="relative overflow-hidden rounded-md sm:rounded-2xl">
          ...
          <div className={`relative ${themeClasses.cardBg} shadow-2xl border ${themeClasses.border} overflow-hidden`}>
            <div className={`p-1 sm:p-4 lg:p-6 border-b ${themeClasses.border}`}>
              <h3 className={`text-xs sm:text-lg lg:text-xl font-bold ${themeClasses.text} text-center`}>Live Weather Map</h3>
            </div>
            <div className="h-24 sm:h-64 md:h-80 lg:h-96">
              <iframe
                src={getWindyUrl()}
        ...
        <div className="grid grid-cols-2 gap-1 sm:grid-cols-4 sm:gap-4 lg:gap-6">
          {[
            { 
              icon: Eye, 
              label: 'Visibility', 
            ...
            <div key={index} className="relative overflow-hidden rounded-md sm:rounded-xl group">
              <div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-10 group-hover:opacity-20 transition-opacity`}></div>
              <div className={`relative ${themeClasses.cardBg} p-1 sm:p-4 lg:p-6 text-center shadow-lg border ${themeClasses.border} backdrop-blur-sm`}>
                <div className="relative mb-1 sm:mb-3">
                  ...
                  <div className={`relative p-1 sm:p-2 bg-gradient-to-r ${item.color} rounded-md`}>
                    <item.icon className="w-2 h-2 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white mx-auto" />
                  </div>
                </div>
                <div className={`text-xs font-bold ${themeClasses.text} mb-0.5`}>{item.value}</div>
                <div className={`text-xs ${themeClasses.textSecondary}`}>{item.label}</div>
                
                {/* Condition Description */}
                {item.condition && (
                  <div className={`${themeClasses.cardBg} p-1 sm:p-2 rounded-md border ${themeClasses.border} text-left mt-1`}>
                    <h5 className={`font-bold ${themeClasses.accent} mb-0.5 text-xs`}>
        ...
        <div className="relative overflow-hidden rounded-md sm:rounded-2xl">
          ...
          <div className={`relative ${themeClasses.cardBg} shadow-2xl border ${themeClasses.border}`}>
            <div className={`p-1 sm:p-4 lg:p-6 border-b ${themeClasses.border}`}>
              <h3 className={`text-xs sm:text-lg lg:text-xl font-bold ${themeClasses.text} text-center flex items-center justify-center space-x-1 sm:space-x-3`}>
                <Activity className={`w-3 h-3 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${themeClasses.accent}`} />
                ...
                <div className="overflow-x-auto pb-1">
                  <div className="flex gap-1" style={{ minWidth: 'max-content' }}>
                    {getHourlyForecast().map((hour, index) => (
                      <div key={index} className="relative overflow-hidden rounded-md flex-shrink-0 min-w-[60px] max-w-[60px]">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm"></div>
                        <div className={`relative ${themeClasses.cardBg} p-1 border ${themeClasses.border} shadow-lg`}>
                          <div className="text-center">
                            <p className={`text-xs ${themeClasses.textSecondary} mb-1 font-semibold truncate`}>
        ...
        <div className="relative overflow-hidden rounded-md sm:rounded-2xl">
          ...
          <div className={`relative ${themeClasses.cardBg} shadow-2xl border ${themeClasses.border}`}>
            <div className={`p-1 sm:p-4 lg:p-6 border-b ${themeClasses.border}`}>
              <h3 className={`text-xs sm:text-lg lg:text-xl font-bold ${themeClasses.text} text-center flex items-center justify-center space-x-1 sm:space-x-3`}>
                <MapPin className={`w-3 h-3 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ${themeClasses.accent}`} />
                <span>Location Info</span>
              </h3>
            </div>
            <div className="p-1 sm:p-4 lg:p-6">
              <div className="grid grid-cols-1 gap-1 sm:gap-4 lg:gap-6">
                {/* Location Name */}
                <div className="text-center">
                  <div className={`${themeClasses.accent} font-semibold mb-0.5 sm:mb-2 text-xs sm:text-sm lg:text-base`}>Surf Spot</div>
                  <div className={`${themeClasses.text} text-xs sm:text-sm lg:text-base font-medium`}>{selectedSpot.name}</div>
                </div>
                
                {/* Coordinates */}
                <div className="text-center">
                  <div className={`${themeClasses.accent} font-semibold mb-0.5 sm:mb-2 text-xs sm:text-sm lg:text-base`}>Coordinates</div>
                ...
                {/* Last Updated */}
                <div className="text-center">
                  <div className={`${themeClasses.accent} font-semibold mb-0.5 sm:mb-2 text-xs sm:text-sm lg:text-base`}>Last Updated</div>
              ...
              {/* Additional Info */}
              <div className="mt-1 sm:mt-6 pt-1 sm:pt-4 border-t border-gray-200 dark:border-gray-700">
                <div className="text-center">
