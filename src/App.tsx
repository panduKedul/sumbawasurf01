        ...
        <div className={`flex-1 flex flex-col transition-all duration-300 ${showMobileMenu ? 'blur-[2px] pointer-events-none' : ''}`}>
          {showWeather ? (
            ...
            <div className="flex flex-col flex-1 bg-dark-200">
              ...
              <div className="p-4 lg:p-8 text-center bg-gradient-radial from-dark-300 to-dark-100">
                <div className="w-full max-w-none sm:max-w-2xl lg:max-w-4xl mx-auto mb-4 sm:mb-6 flex flex-col items-center px-2 sm:px-4">
                  <h1 className="text-xl sm:text-2xl lg:text-4xl font-bold text-neon-blue mb-2 text-center">Welcome to Sumbawa Surf Guide</h1>
                  <h2 className="text-base sm:text-lg lg:text-2xl font-semibold text-white mb-3 sm:mb-4 text-center">Your Ultimate West Sumbawa Surf Companion</h2>
                  <p className="text-xs sm:text-sm lg:text-base text-gray-400 mb-4 sm:mb-6 text-center max-w-none sm:max-w-xl lg:max-w-2xl px-2">
                ...
                {/* Interactive Map */}
                <div className="h-[30vh] sm:h-[40vh] lg:h-[50vh] rounded-xl overflow-hidden shadow-2xl border border-dark-400 mb-4 sm:mb-6 w-full max-w-none sm:max-w-2xl lg:max-w-4xl mx-auto">
                  <Map spots={spots} onSelectSpot={handleSpotSelect} selectedSpot={selectedSpot} />
                </div>
              </div>
              
              <div className="flex-1 overflow-auto">
                <div className="w-full max-w-none sm:max-w-2xl lg:max-w-4xl mx-auto px-2 sm:px-4 lg:px-6">
                {selectedSpot ? (
                  ...
                  <div className="p-6 text-center animate-fadeIn">
                    <div className="w-full max-w-none sm:max-w-xl lg:max-w-2xl mx-auto">
                      {/* Quick Stats */}
                      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
                        <div className="bg-dark-400 p-2 sm:p-4 rounded-lg border border-dark-500 text-center">
                          <div className="text-lg sm:text-2xl font-bold text-neon-blue">{spots.length}</div>
                          <div className="text-xs sm:text-sm text-gray-400">Surf Spots</div>
                        </div>
                        <div className="bg-dark-400 p-2 sm:p-4 rounded-lg border border-dark-500 text-center">
                          <div className="text-lg sm:text-2xl font-bold text-neon-blue">24/7</div>
                          <div className="text-xs sm:text-sm text-gray-400">Forecasts</div>
                        </div>
                        <div className="bg-dark-400 p-2 sm:p-4 rounded-lg border border-dark-500 text-center">
                          <div className="text-lg sm:text-2xl font-bold text-neon-blue">Live</div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                        <div className="bg-dark-400 p-3 sm:p-4 rounded-lg border border-dark-500 text-center">
